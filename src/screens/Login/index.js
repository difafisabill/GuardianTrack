      ...
      <View style={styles.container}>
        <View>
          ...
          <Text style={styles.caption}>
            Let’s log in to your account and roll in to GuardianTrack!
          </Text>
        ...
        <View style={{gap: 10}}>
          <TouchableHighlight
            ...
            {loading ? (
              <ActivityIndicator color={colors.old_blue()} />
            ) : (
          ...
          <View style={{flexDirection: 'row', gap: 5, alignSelf: 'center'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Register')}>
              <Text style={[button.label, {color: colors.old_purple()}]}>
                Sign up
              </Text>
            </TouchableOpacity>
          </View>
